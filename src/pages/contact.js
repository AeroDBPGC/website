        ...
        <Container fluid="true" className={contactPageStyle.c2}>
            ...
            <Row noGutters="true" style={{ padding:`.5rem`, display:`flex`, flexGrow:`1` }}>
                <Col lg={6} xl={3} md={6} xs={12}>
                    <ContactCard background="linear-gradient(45deg, #606c88, #3f4c6b)"></ContactCard>
                </Col>
                <Col lg={6} xl={3} md={6} xs={12}>
                    <ContactCard background="linear-gradient(45deg, #e13680, #a43ab2)"></ContactCard>
                </Col>
                <Col lg={6} xl={3} md={6} xs={12}>
                    <ContactCard background="linear-gradient(220deg, #F7971E, #FFD200)"></ContactCard>
                </Col>
                <Col lg={6} xl={3} md={6} xs={12}>
                    <ContactCard background="linear-gradient(45deg, #41d8dd, #5583ee)"></ContactCard>
                </Col>
            </Row>
        </Container>
    </div>
